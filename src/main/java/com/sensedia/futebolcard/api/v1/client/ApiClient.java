package com.sensedia.futebolcard.api.v1.client;
...
import com.sensedia.futebolcard.api.v1.client.auth.HttpBasicAuth;
import com.sensedia.futebolcard.api.v1.client.auth.ApiKeyAuth;
import com.sensedia.futebolcard.api.v1.client.auth.OAuth;
import com.sensedia.futebolcard.api.v1.client.auth.OAuth.AccessTokenListener;
import com.sensedia.futebolcard.api.v1.client.auth.OAuthFlow;
...
public class ApiClient {
  ...
  public void createDefaultAdapter() {
    ...
    String baseUrl = "https://api-visa.sensedia.com/sandbox/visa/futebolcard/v1";
    if(!baseUrl.endsWith("/"))
      baseUrl = baseUrl + "/";
