...
import com.sensedia.futebolcard.api.v1.model.Gates;
...
public class Sectors {
  ...
  public Sectors gates(List<Gates> gates) {
    this.gates = gates;
    return this;
  }

  public Sectors addGatesItem(Gates gatesItem) {
    if (this.gates == null) {
  ...
  **/
  ...
  public Sectors map(java.util.Map map) {
    this.map = map;
    return this;
  }
